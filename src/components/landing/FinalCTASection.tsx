    ...
    <section ref={sectionRef} className="py-24 md:py-32 px-6 lg:px-12 relative overflow-hidden" style={{ background: '#EDEDEA' }}>
      ...
      <div className={cn(
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(62, 207, 165, 0.15) 0%, transparent 70%)', filter: 'blur(40px)' }}
        />
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className={cn(
          ...
          <Link
            to="/scenarios"
            className="btn-teal inline-flex items-center gap-3 text-lg px-10 py-5"
          >
            Run a simulation
